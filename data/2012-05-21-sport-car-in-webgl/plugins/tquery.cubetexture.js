...
tQuery.TextureCube.WellKnownUrls	= {
	bridge2			: tQuery.TextureCube.createUrls('Bridge2', '.jpg', 'images/textures/cube', 'pos', 'neg'),
	escher			: tQuery.TextureCube.createUrls('Escher', '.jpg', 'images/textures/cube'),
	park2			: tQuery.TextureCube.createUrls('Park2', '.jpg', 'images/textures/cube', 'pos', 'neg'),
	park3Med		: tQuery.TextureCube.createUrls('Park3Med', '.jpg', 'images/textures/cube'),
	pisa			: tQuery.TextureCube.createUrls('pisa', '.png', 'images/textures/cube'),
	skybox			: tQuery.TextureCube.createUrls('skybox', '.jpg', 'images/textures/cube'),
	swedishRoyalCastle	: tQuery.TextureCube.createUrls('SwedishRoyalCastle', '.jpg', 'images/textures/cube')
};
